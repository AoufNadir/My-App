...
assert.match(mainAppSource, /subscribeCoreFinancial:\s*!shouldUseDashboardReadModel/, 'Dashboard read mode must not subscribe to full legacy financial history');
