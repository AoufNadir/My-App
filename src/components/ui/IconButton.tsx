...
export type IconButtonVariant = 'edit' | 'delete' | 'view' | 'close' | 'add' | 'ghost';
...
const SIZE_CLASSES: Record<IconButtonSize, string> = {
    sm: 'h-touch w-touch [&>svg]:h-4 [&>svg]:w-4',
    md: 'h-touch w-touch [&>svg]:h-5 [&>svg]:w-5',
    lg: 'h-touch-lg w-touch-lg [&>svg]:h-6 [&>svg]:w-6',
};
