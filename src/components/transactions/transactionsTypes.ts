...
export type TransactionFilterMode = 'all' | 'buy_usdt_dzd' | 'buy_usdt_eur' | 'buy_eur_dzd' | 'sell_usdt_dzd' | 'sell_usdt_eur' | 'sell_eur_dzd' | 'stock_in' | 'stock_out' | 'client_receipts_cash' | 'client_receipts_baridi' | 'client_receipts_credit' | 'client_payouts_cash' | 'client_payouts_baridi' | 'client_payouts_credit' | 'client_adjustments' | 'treasury_in_cash' | 'treasury_in_baridi' | 'treasury_out_cash' | 'treasury_out_baridi' | 'treasury_transfers' | 'client_transfers'
