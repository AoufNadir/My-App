...
import { ClientTransferDialog, TreasuryBalanceEditDialog, PortfolioBalanceEditDialog, DateFilterDialog } from './MainDialogs';
...
function MainTransferAndFilterDialogsComponent({ clientTransferProps, treasuryBalanceEditProps, portfolioBalanceEditProps, dateFilterProps }: MainTransferAndFilterDialogsProps) {
    return (<>
...
const areMainTransferAndFilterDialogsPropsEqual = (prev: MainTransferAndFilterDialogsProps, next: MainTransferAndFilterDialogsProps) => (prev.clientTransferProps === next.clientTransferProps
...
export const MainTransferAndFilterDialogs = memo(MainTransferAndFilterDialogsComponent, areMainTransferAndFilterDialogsPropsEqual);
