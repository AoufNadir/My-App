...
const DigitalServiceSaleModal = React.lazy(() => import('../modals/DigitalServiceSaleModal').then((module) => ({ default: module.DigitalServiceSaleModal })));
...
export function MainAppDialogs(props: MainAppDialogsProps) {
    ...
    // project expense
    isDeliveryExpenseModalOpen, closeDeliveryExpenseModal, deliveryExpenseAmount, setDeliveryExpenseAmount, deliveryExpenseMethod, setDeliveryExpenseMethod, deliveryExpenseDate, setDeliveryExpenseDate, deliveryExpenseNote, setDeliveryExpenseNote, deliveryExpensePreview, handleSaveDeliveryExpense,
    // digital service sale
    isDigitalServiceModalOpen, closeDigitalServiceModal, isDigitalServiceSaving, digitalServiceClientId, setDigitalServiceClientId, digitalServiceName, setDigitalServiceName, digitalServicePurchaseWallet, setDigitalServicePurchaseWallet, digitalServicePurchaseAmount, setDigitalServicePurchaseAmount, digitalServiceSaleWallet, setDigitalServiceSaleWallet, digitalServiceSaleAmount, setDigitalServiceSaleAmount, digitalServiceDate, setDigitalServiceDate, digitalServiceNote, setDigitalServiceNote, digitalServicePreview, handleSaveDigitalService,
    ...
    return (<>
            ...
            {isDeliveryExpenseModalOpen && (<Suspense fallback={null}>
                    <DeliveryExpenseModal isOpen={isDeliveryExpenseModalOpen} onClose={closeDeliveryExpenseModal} isSaving={isSaving} amount={deliveryExpenseAmount} setAmount={setDeliveryExpenseAmount} method={deliveryExpenseMethod} setMethod={setDeliveryExpenseMethod} date={deliveryExpenseDate} setDate={setDeliveryExpenseDate} note={deliveryExpenseNote} setNote={setDeliveryExpenseNote} treasuryStats={treasuryStats} portfolioStats={portfolioStats} preview={deliveryExpensePreview} onSave={handleSaveDeliveryExpense}/>
                </Suspense>)}
            {isDigitalServiceModalOpen && (<Suspense fallback={null}>
                    <DigitalServiceSaleModal isOpen={isDigitalServiceModalOpen} onClose={closeDigitalServiceModal} isSaving={isDigitalServiceSaving} clientId={digitalServiceClientId} setClientId={setDigitalServiceClientId} serviceName={digitalServiceName} setServiceName={setDigitalServiceName} purchaseWallet={digitalServicePurchaseWallet} setPurchaseWallet={setDigitalServicePurchaseWallet} purchaseAmount={digitalServicePurchaseAmount} setPurchaseAmount={setDigitalServicePurchaseAmount} saleWallet={digitalServiceSaleWallet} setSaleWallet={setDigitalServiceSaleWallet} saleAmount={digitalServiceSaleAmount} setSaleAmount={setDigitalServiceSaleAmount} date={digitalServiceDate} setDate={setDigitalServiceDate} note={digitalServiceNote} setNote={setDigitalServiceNote} clientsDzd={clientsDzd} treasuryStats={treasuryStats} portfolioStats={portfolioStats} preview={digitalServicePreview} onOpenClientModal={openClientModal} onSave={handleSaveDigitalService}/>
                </Suspense>)}
            {isPersonalWithdrawalModalOpen && (<Suspense fallback={null}>
                    <PersonalWithdrawalModal isOpen={isPersonalWithdrawalModalOpen} onClose={closePersonalWithdrawalModal} isSaving={isSaving} amount={personalWithdrawalAmount} setAmount={setPersonalWithdrawalAmount} method={personalWithdrawalMethod} setMethod={setPersonalWithdrawalMethod} date={personalWithdrawalDate} setDate={setPersonalWithdrawalDate} note={personalWithdrawalNote} setNote={setPersonalWithdrawalNote} mode={personalWithdrawalMode} setMode={setPersonalWithdrawalMode} treasuryStats={treasuryStats} portfolioStats={portfolioStats} preview={personalWithdrawalPreview} managerAvailableProfit={managerAvailableProfit} managerCapitalInvested={managerCapitalInvested} managerExists={managerExists} editingTx={editingPersonalExpenseTx} onSave={handleSavePersonalWithdrawal}/>
                </Suspense>)}
