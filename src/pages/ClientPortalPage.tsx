...
function buildStrings(lang: string): Strings {
    ...
    return {
        ...
        debt: ar ? 'دفع مؤجل' : 'Paiement différé',
        ...
        statusLabels: ar
            ? {
                ...
                CANCELLED: 'ملغى',
                REJECTED: 'مرفوض',
                DEBT_ACTIVE: 'دفع مؤجل قائم',
                DEBT_PAID: 'تمت تسوية الدفع المؤجل',
            }
            : {
                NEW: 'Nouveau',
                ...
                CANCELLED: 'Annulé',
                REJECTED: 'Rejeté',
                DEBT_ACTIVE: 'Paiement différé en cours',
                DEBT_PAID: 'Paiement différé réglé',
            },
