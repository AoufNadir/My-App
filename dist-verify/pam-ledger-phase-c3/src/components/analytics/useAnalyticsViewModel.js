...
export function useAnalyticsViewModel({ transactions, usdtReportMonth, usdtReportYear, simMode, simSellUsdtQty, simSellDzdPrice, parseAndEvaluate, portfolioUsdtAvgBuy, clientTransactionsDzd, clientsDzd, getClientFullName, t }) {
    ...
    const simSellResult = useMemo(() => {
        if (simMode !== 'sell_dzd' || !simSellUsdtQty || !simSellDzdPrice || !parseAndEvaluate)
            return null;
